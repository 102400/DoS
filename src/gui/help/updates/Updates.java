...
public class Updates extends JPanel {
	...
	public Updates(){
		...
		textArea.setText("下载地址:https://github.com/102400/DoS/archive/master.zip\n网络问题可能会造成程序假死或崩溃");
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{
					URL url = new URL("https://github.com/102400/DoS/raw/master/changelog.txt");  //changelog.txt地址
					...
					temp.append("\n下载地址:https://github.com/102400/DoS/archive/master.zip");
